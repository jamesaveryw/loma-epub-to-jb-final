Lesson_Data_File([
    {
        "Page_Setup": {
            ...
            "Lesson_Title_Text": "",
            "Page_Title": "The Agency Relationship",
        ...
        "JBuilder_Content": [
            {
                "Heading_New": [
                    {
                        "sngl_Heading": "The Agency Relationship"
                    },
                    {
                        "alignment": "center"
                    },
            ...
            },
            {
                "List_text_paragraph": [
                    ...
                    },
                    {
                        "Top_Paragraphs": [
                            {
                                "Paragraph_text": "An agency relationship can take many forms. Here are a few examples of some familiar transactions that may involve agency relationship:"
                            }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        "list_items": [
                            {
                                "lstText": "<em>Real estate transactions</em>. A person selects a real estate agent to represent him in the sale or purchase of a home."
                            },
                            {
                                "lstText": "<em>Financial services transactions</em>. An investor selects a stockbroker to purchase stock on her behalf."
                            },
                            {
                                "lstText": "<em>Contract negotiations</em>. An athlete chooses an agent to represent him in contract negotiations."
                            }
                        ]
                    },
                    {
            ...
            },
            {
                "List_text_paragraph": [
                    ...
                    },
                    {
                        "Top_Paragraphs": [
                            {
                                "Paragraph_text": "Typically, an agency relationship is created by an agreement between the principal and agent. As part of an agency agreement, the principal confers actual authority on the agent. <span class=\"keyterm\" tabindex=\"0\" role=\"button\">Actual authority</span> is the authority to act on behalf of the principal that the principal intentionally confers on the agent and that the agent reasonably believes is conferred. Actual authority can be either express or implied."
                            }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        "list_items": [
                            {
                                "lstText": "<span class=\"keyterm\" tabindex=\"0\" role=\"button\">Express authority</span> is the authority that a principal explicitly confers on an agent."
                            },
                            {
                                "lstText": "<span class=\"keyterm\" tabindex=\"0\" role=\"button\">Implied authority</span>, or <em>incidental authority</em>, is the authority that a principal intends an agent to have and that arises incidentally from an express grant of authority. Implied authority is included with express authority. It gives an agent the authority to do all the other acts that are reasonably necessary to carry out her express duties."
                            }
                        ]
                    },
                    {
                ...
                "Paragraphs_New": [
                    {
                        ...
                        "border_style": "",
                        "border_radius": "0px",
                        "heading": "Effect of Agency Relationship",
                        "heading_font_size": "h3",
                        "heading_alignment": "center",
                        "heading_color": "#015d52",
                        "heading_weight": "bold",
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "A policyowner calls an insurer’s customer service number shown on her policy. The policyowner may rely on the information provided by the customer service representative who, for this purpose, is acting in the capacity of an agent for the insurer. If the policyowner discloses information relevant to the policy, this information is considered to be knowledge that the insurer has gained even if the customer service representative did not document the information."
                    }
                ]
            },
            {
                ...
                "Paragraphs_New": [
                    {
                        ...
                        "border_style": "",
                        "border_radius": "0px",
                        "heading": "Capacity of the Parties",
                        "heading_font_size": "h3",
                        "heading_alignment": "center",
                        "heading_color": "#015d52",
                        "heading_weight": "bold",
                    ...
                    {
                        "Paragraph_txt": "The legal effect of a contract entered into by an agent on behalf of the principal may vary based on the contractual capacity of the parties."
                    }
                ]
            },
            {
                "Paragraphs_New": [
                    {
                        ...
                        "border_style": "",
                        "border_radius": "0px",
                        "heading": "Contractual Capacity of the Principal",
                        "heading_font_size": "h4",
                        "heading_alignment": "center",
                        "heading_color": "",
                        "heading_weight": "bold",
                ...
                "Paragraphs_New": [
                    {
                        ...
                        "border_style": "",
                        "border_radius": "0px",
                        "heading": "Contractual Capacity of the Agent",
                        "heading_font_size": "h4",
                        "heading_alignment": "center",
                        "heading_color": "",
                        "heading_weight": "bold",
                    ...
                    {
                        "Paragraph_txt": "An agent who enters into a contract on his principal’s behalf is not a party to that contract. Thus, the agent generally does not need to have contractual capacity to form a contract that binds the principal. In appointing an agent, however, the principal assumes the risks of being represented by the agent. For example, if a competent principal appoints a minor as her agent, any contract the minor enters into within the scope of his authority as an agent is binding on the principal. Because the agent is a minor, however, the agency agreement between the agent and principal is voidable by the minor."
                    }
                ]
            },
            {
                "Question_Comp": [
                    ...
                    },
                    {
                        "question_answers": [
                            {
                                "q_answer": "Apparent / Express",
                                "true_false": false,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "Apparent / Implied",
                                "true_false": false,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "Actual / Express",
                                "true_false": true,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "Actual / Implied",
                                "true_false": false,
                                "q_feedback": ""
                            }
                        ]

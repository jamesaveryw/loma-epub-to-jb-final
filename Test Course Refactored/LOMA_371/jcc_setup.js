...
var course_settings = 
	{
		"Portal_Setup":
			{	
				...
				"Course_Number": "371",
				"Course_Folder": "LOMA_371",				
				"Course_Name": "LOMA 371", // PLEASE KEEP THIS SAME FORMAT --> "LOMA 361", "SRI 111", etc !!!!
				...
				"Welcome_text": {
					//HYBRID
					"Intro_Copy": [
						"LOMA 371—<i>Risk Management and Product Development for Life Insurance Companies</i>—discusses how insurance companies approach the processes of risk management and product development, as well as how the presence of risk informs both general product development and technical product design. Select <b>About</b> for a course overview.",
					...
					/*"Intro_Copy": [
						...
						"The <b>Course Content</b> is divided into 4 modules. Each module contains several chapters from the text.",
	...
	"CourseContentContent":
		{
			...
			//"KotobeeReader": "Kotobee Reader",			
			"AnswerKeyPDF": "pdf/Answer Key 371-TXTPDF-21.pdf",
			"moduleEBooks": true,
			"pdflinks":[
						{"link":"LOMA371_M1.pdf"},//Module
						{"link":"LOMA371_M2.pdf"},//Module
						{"link":"LOMA371_M3.pdf"},//Module
						{"link":"LOMA371_M4.pdf"},//Module
			...
			"ebooklinks":[
						{"link":"LOMA371_M1.epub"}, // M1
						{"link":"LOMA371_M2.epub"}, // M2
						{"link":"LOMA371_M3.epub"}, // M3
						{"link":"LOMA371_M4.epub"}, // M3
						{"link":"LOMA371.epub"} // WHOLE - NOT USED
			]
		},
	...
	"Lesson_setup":[
		...
		//-------<( Module 1 )>-------		//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
		{
			...
			"List":[
						{"List_info":"<b>Chapter 1:</b> Introduction to Risk Management and the Actuarial Function"},
						{"List_info":"<b>Chapter 2:</b> Solvency Standards and Risks Life Insurers Manage"},
						{"List_info":"<b>Chapter 3:</b> Risk Management Strategies"},
						{"List_info":"<b>Chapter 4:</b> Financial Modeling in Risk Management and Product Design"},
					],	
			...
			//HYBRID
			"Instructions":[
				"Select <b>Module 1 e-book</b> to download the content to your e-reader. Or, if you are unable to access the e-book, select <b>Module 1 PDF</b>. <br><br><span style=\"font-style:italic;\">If videos do not play on your device, you can view them in the Resources section of the Course Portal.</span>",
		...
		//-------<( Module 2 )>-------				//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
		{
			...
			"List":[
						{"List_info":"<b>Chapter 5:</b> New Product Considerations, Planning and Analysis"},
						{"List_info":"<b>Chapter 6:</b> Technical Product Design, Product Introduction, and Product Monitoring"},
					],
			...
			//HYBRID
			"Instructions":[
				"Select <b>Module 2 e-book</b> to download the content to your e-reader. Or, if you are unable to access the e-book, select <b>Module 2 PDF.</b><br><br><span style=\"font-style:italic;\">If videos do not play on your device, you can view them in the Resources section of the Course Portal.</span>",
		...
		//-------<( Module 3 )>-------			//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
		{
			...
			"List":[
						{"List_info":"<b>Chapter 7:</b> Investment Earnings and Technical Product Design"},
						{"List_info":"<b>Chapter 8:</b> Mortality Assumptions and Tables"},
						{"List_info":"<b>Chapter 9:</b> Operating Expenses and Policyholder Behavior in Technical Product Design"},
					],
			...
			//HYBRID
			"Instructions":[
				"Select <b>Module 3 e-book</b> to download the content to your e-reader. Or, if you are unable to access the e-book, select <b>Module 3 PDF</b>.<br><br><span style=\"font-style:italic;\">If videos do not play on your device, you can view them in the Resources section of the Course Portal.</span>",
		...
		//-------<( Module 4 )>-------			//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
		{
			...
			"List":[
						{"List_info":"<b>Chapter 10:</b> Life Insurance Technical Product Design"},
						{"List_info":"<b>Chapter 11:</b> Annuity Technical Product Design"},
						],
			...
			//HYBRID
			"Instructions":[
				"Select <b>Module 4 e-book</b> to download the content to your e-reader. Or, if you are unable to access the e-book, select <b>Module 4 PDF</b>.<br><br><span style=\"font-style:italic;\">If videos do not play on your device, you can view them in the Resources section of the Course Portal.</span>",
		...
		//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
		{
			...
			//HYBRID
			"Instructions":[
				"Select <b>Module 5 e-book</b> to download the content to your e-reader. Or, if you are unable to access the e-book, select <b>Module 5 PDF</b>.<br><br><span style=\"font-style:italic;\">If videos do not play on your device, you can view them in the Resources section of the Course Portal.</span>",
		...
		//-------<( Module 6 )>-------			//-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
		{
			...
			//HYBRID
			"Instructions":[
				"Select <b>Module 6 e-book</b> to download the content to your e-reader. Or, if you are unable to access the e-book, select <b>Module 6 PDF</p>.<br><br><span style=\"font-style:italic;\">If videos do not play on your device, you can view them in the Resources section of the Course Portal.</span>",
	...
	"Glossary":
	{
		...
		"SubIntro": "<em>The LOMA 371 Glossary</em> Copyright &copy; 2020 LL Global, Inc. All rights reserved. Copying, downloading, reproducing, republishing, transmitting, or otherwise disseminating this content in any form or by any means, electronic or mechanical, without permission from LL Global is a violation of U.S. federal law and international law."
	},
                ...
                "buttons":[
					{
						...
						"link": "LOMA_371_PQ_0_1.html"
					},
					{
						"module": "1",
						"prepLabel": "Chapter 2",
						"modLabel": "Ch.2 Practice",
						"link": "LOMA_371_PQ_0_2.html"
					},
					{
						"module": "1",
						"prepLabel": "Chapter 3",
						"modLabel": "Ch.3 Practice",
						"link": "LOMA_371_PQ_0_3.html"
					},
					{
						"module": "1",
						"prepLabel": "Chapter 4",
						"modLabel": "Ch.4 Practice",
						"link": "LOMA_371_PQ_0_4.html"
					},
					{
						"module": "2",
						"prepLabel": "Chapter 5",
						"modLabel": "Ch.5 Practice",
						"link": "LOMA_371_PQ_0_5.html"
					},
					{
						"module": "2",
						"prepLabel": "Chapter 6",
						"modLabel": "Ch.6 Practice",
						"link": "LOMA_371_PQ_0_6.html"
					},
					{
						"module": "3",
						"prepLabel": "Chapter 7",
						"modLabel": "Ch.7 Practice",
						"link": "LOMA_371_PQ_0_7.html"
					},
					{
						"module": "3",
						"prepLabel": "Chapter 8",
						"modLabel": "Ch.8 Practice",
						"link": "LOMA_371_PQ_0_8.html"
					},
					{
						"module": "3",
						"prepLabel": "Chapter 9",
						"modLabel": "Ch.9 Practice",
						"link": "LOMA_371_PQ_0_9.html"
					},
					{
						"module": "4",
						"prepLabel": "Chapter 10",
						"modLabel": "Ch.10 Practice",
						"link": "LOMA_371_PQ_0_10.html"
					},
					{
						"module": "4",
						"prepLabel": "Chapter 11",
						"modLabel": "Ch.11 Practice",
						"link": "LOMA_371_PQ_0_11.html"
					},
                ...
                "buttons":[
                    {
                        ...
                        "link": "LOMA_371_SE.html"
                    },
                    {
                        "prepLabel": "Mod 1 Sample Exam",
                        "link": "LOMA_371_SE_1.html"
                    },
                    {
                        "prepLabel": "Mod 2 Sample Exam",
                        "link": "LOMA_371_SE_2.html"
					},
					{
                        "prepLabel": "Mod 3 Sample Exam",
                        "link": "LOMA_371_SE_3.html"
					},
					{
                        "prepLabel": "Mod 4 Sample Exam",
                        "link": "LOMA_371_SE_4.html"
					},
                ]
            },
        ]

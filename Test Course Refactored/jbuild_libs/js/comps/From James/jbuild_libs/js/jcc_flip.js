...
! function(a) {
    ...
    a.extend(c.prototype, {
        ...
        flip: function(a) {
         ...
         //  alert( document.getElementById("keyModal").style.display )

           // document.getElementById("myP").style.borderTop;

		//if(document.getElementById("keyModal").style.display !== "block")	
		//	{
				if (!this.isFlipped) {
					this.isFlipped = !0;

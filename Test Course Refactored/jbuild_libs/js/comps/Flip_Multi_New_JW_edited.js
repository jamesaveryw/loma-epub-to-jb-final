...
c_div_maker = c_div_maker + "<p style='margin-top:10px;color:"+card_decor_whole_array[cct][3]+";text-align:"+card_decor_whole_array[cct][5]+"'><"+card_decor_whole_array[cct][6]+">"+card_decor_whole_array[cct][4]+"</"+card_decor_whole_array[cct][6]+"></p>"; 
 ...
 c_div_maker = c_div_maker + "<div style='perspective: 2280px; position: relative;height:350px;width:auto'>"; //width:"+cwd+" commented out on 04/25/2022
...
switch(fcc)
  {
    case "Paragraphs_New":
      pgflp = flip_card_data[dtnum][contents_values_array[dtnum]];
            ...
            c_div_maker = c_div_maker + "<div tabindex='-1' class='col-lg-12 col-md-12 col-xs-12' style='height:auto; padding: 0px 20px; background-color:"+pgflp[0].background_color+"; border-top-color:"+pgflp[0].border_color+"; border-top-width:"+pgflp[0].border_weight+"; border-top-style:"+pgflp[0].border_style+"; border-bottom-color:"+pgflp[0].border_color+"; border-bottom-width:"+pgflp[0].border_weight+"; border-bottom-style:"+pgflp[0].border_style+"; border-radius:"+pgflp[0].border_radius+"; margin-top:"+pgflp[0].top_margin+";'>"; 
    ...
    case "List_text_paragraph":
      ...
      c_div_maker = c_div_maker + "<div tabindex='-1' class='col-lg-12 col-md-12 col-xs-12' style=' background-color:"+ltpflp[5].background_color+"; margin-top:" + ltpflp[4].top_margin+";'>";
...
c_div_maker = c_div_maker +  "<div tabindex='-1' id='IMG_WTL_flip_"+dtnum+"' class='col-lg-12 col-md-12 col-xs-12 c_jb_car_acc_wd' style='margin-top:10px; background-color:"+imt_flip_back+"'>";             
...
function FL_show_L_image(cmp_img,cmp_id,cmpnm,crdnum, e)
        {
//card_"+c_ccnum+"_"+cct+"
          console.log("@@@@@@@@@@@@@@@@@@@@@@@@")
...
function rf_flip(comp_number,crd_number,cdface) //event
{

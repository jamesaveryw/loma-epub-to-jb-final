...
//console.log("c_flip_data_stream length: " +c_flip_data_stream.length);
        ...
        for(var crd_dta = 1; crd_dta < c_flip_data_stream.length;crd_dta++)
        {
          switch(crd_dta % 2)
          {
                        ...
                        //-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-  
                         ...
                         //console.log("comp_in_flipcard_array[crd_dta]: " + comp_in_flipcard_array[crd_dta]);
                          //card_0_1
                         //console.log("card_setup_all_array[c_card][0]: " + card_setup_all_array[c_card][0]);

                         c_div_maker = c_div_maker + "<div class='jb_car_acc_wd' style='background-color:"+card_setup_all_array[c_card][0]+"'>"; //  Begin	card front

                         console.log("String(Object.keys(c_flip_data_stream[crd_dta])): "  + String(Object.keys(c_flip_data_stream[crd_dta])));
                         flip_function_name = String(Object.keys(c_flip_data_stream[crd_dta]));

                         flip_function_name = String(Object.keys(c_flip_data_stream[crd_dta]));
                         console.log("flip_function_name: " + flip_function_name);

                      


                        // var c_flip_function = window[flip_function_name];

                      //console.log("[comp_in_flipcard_array[crd_dta]: " + comp_in_flipcard_array[crd_dta]);

                         console.log("=======> " + c_flip_data_stream[crd_dta][comp_in_flipcard_array[crd_dta]]);
                         //console.log("crd_dta: " + crd_dta);
                       
                        
                        var c_flip_function = window[flip_function_name];
                        //c_flip_function(c_flip_data_stream[crd_dta][comp_in_flipcard_array[crd_dta]]); 
            ...
            for(var crd_dta = 1; crd_dta < c_flip_data_stream.length;crd_dta++)
                  ...
                  */
                            ...
                            c_div_maker = c_div_maker + "</div>"; // Card Ends
                             ...
                             // c_div_maker = c_div_maker + "<div>"+card_setup_all_array[c_card][8]+"</div>";  padding:10px; margin:auto;


                        c_div_maker = c_div_maker + "</div>";
                 //-------<( flip_card_data[0].card_01_header_title )>-------
                 c_div_maker = c_div_maker + "<div style='height:40px; text-align:"+card_setup_all_array[c_card][5]+"'><"+card_setup_all_array[c_card][6]+" style='color:"+card_setup_all_array[c_card][7]+"'>"+card_setup_all_array[c_card][8]+"</"+card_setup_all_array[c_card][6]+"></div>";	
                 //-------<( flip_card_data[0].card_01_header_title )>-------
...
console.log(clknum + " | " + crdnum);

//card_0_1
//document.getElementById("card_" + clknum + "_" + crdnum).style.display = "none";

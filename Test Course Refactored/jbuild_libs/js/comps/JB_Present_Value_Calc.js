...
function JB_Present_Value_Calc(pvc_data_stream,c_ccnum) 
{
    pvc = 1;
    console.log("-------<(  JB_Widget_Player Code  )>-------")
    //console.log(Object.values(pvc_data_stream[0]).length); 

var pvc_data = Object.values(pvc_data_stream[0]);

   // console.log(pvc_data)

    //console.log(pvc_data)

    //console.log("-------<(  JB_Widget_Player Code  )>-------")

    c_div_maker = c_div_maker + "<div id='Present_Value_Calc_"+ c_ccnum +"' class='col-lg-12 col-md-12 col-xs-12'>";
      ...
      c_div_maker = c_div_maker + "<div style='text-align:left' class='jb_mx_wd'>"+pvc_data[9]+"</div>";
            ...
            c_div_maker = c_div_maker + "<table style='width:100%;border-spacing: 50px;background-color:"+pvc_data[0]+"'>";
                ...
                c_div_maker = c_div_maker + "<tr>";																	
                        ...
                        c_div_maker = c_div_maker + "<td class='pv_fv_td_border' style='width:20%; text-align:center'><span id='iRate' style='border-style:solid; border-color:black; border-weight:medium;padding:10px; background-color:white; display: inline-block; width:60px;font-size:18px; font-weight:bold; color:#000000'></span></td>";	                
...
//===========================
                ...
                c_div_maker = c_div_maker + "<tr>";					
                        ...
                        c_div_maker = c_div_maker + "<td class='pv_fv_td_border' style='width:20%; text-align:center'><span id='iYear' style='border-style:solid; border-color:black; border-weight:medium;padding:10px; background-color:white; display: inline-block; width:60px;font-size:18px; font-weight:bold;color: #000000'></span></td>";								
...
c_div_maker = c_div_maker + "<div id='rotText'><vert_label>"+pvc_data[12]+"</vert_label></div>"; //	id='rotText'						
            ...
            c_div_maker = c_div_maker + "<div class='value_bar_setup' id='value_bar' style='width:100px; height:100px;background-color:#009539;'><div style='margin-top:-30px;' align='center'><span class='calc_readout' id='calc_value'></span></div></div>";

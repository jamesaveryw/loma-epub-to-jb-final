...
c_div_maker = c_div_maker + "<div class='quest_char' style='margin-top:50px; text-align:left'>";
    c_div_maker = c_div_maker + "<form id='fbqs_"+c_ccnum +"_an_"+c_qAns+"' class='c_qSpacing c_jb_column1'>";
        c_div_maker = c_div_maker + "<div class='c_checkboxes'>";
for(var c_qAns = 0; c_qAns < c_questionData[4].question_answers.length; c_qAns++)
{
    
   //  /*
                                                                           //true_false
                                            //alert(  c_questionData[4].question_answers[c_qAns].true_false ); name='vehicle1'
    c_div_maker = c_div_maker + "<input class='c_check' type='checkbox' id='quest_"+ c_ccnum +"_"+c_qAns+"' value='"+c_questionData[4].question_answers[c_qAns].true_false+"'>";
    c_div_maker = c_div_maker + "<label><p> "+c_questionData[4].question_answers[c_qAns].q_answer+"</p></label><br>";




    //for='vehicle1'   style='margin-top:-22px;'
...
//c_div_maker = c_div_maker + "<input onclick='nQue("+c_questionData[0].Question_type+","+c_questionData[4].question_answers[qAns].true_false+","+c_ccnum+","+qAns+","+QA_num+");' type='checkbox' id='cbck_"+c_ccnum+"_"+qAns+"'>";

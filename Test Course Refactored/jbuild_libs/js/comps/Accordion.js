...
console.log("c_ccnum from Acc: " + c_ccnum);
...
//console.log("c_ac_data_stream[acc_tab_cnt].Acc_Label: " + Object.keys(c_ac_data_stream[acc_tab_cnt]).length) //.Acc_Label);

///console.log("c_ac_data_stream[acc_tab_cnt].Acc_Label: " + c_ac_data_stream[acc_tab_cnt].Acc_Label) //.Acc_Label);

//console.log("=================================================================================")
//console.log("c_ac_data_stream[acc_tab_cnt].length: " + Object.keys(c_ac_data_stream[acc_tab_cnt]).length) 
//console.log("=================================================================================")


c_div_maker = c_div_maker + "<div class='panel-heading' style='background-color:#0070b0'>"; // Heading Start

if(Object.keys(c_ac_data_stream[acc_tab_cnt]).length === 1)
			{
				//console.log("=================================================================================")
				console.log("c_ac_data_stream[acc_tab_cnt].Acc_Label: " + c_ac_data_stream[acc_tab_cnt].Acc_Label);
				//console.log("=================================================================================")
				c_div_maker = c_div_maker + "<jb2 class='panel-title' role='heading'><button class='btn_w_image c_lesson_width' aria-label='Accordion button "+c_ac_data_stream[acc_tab_cnt].Acc_Label.replace(/'/g, "\\'")+"' style='color:#ffffff' data-toggle='collapse' data-parent='#jb_accordion_" + c_ccnum + "'' href='#collapse" + c_ccnum + "_" + acc_Count + "' onclick='pvid(" + c_ccnum + "," + acc_Count + ")' aria-controls='collapse" + c_ccnum + "_" + acc_Count + "'>" + c_ac_data_stream[acc_tab_cnt].Acc_Label + "</button>"; 

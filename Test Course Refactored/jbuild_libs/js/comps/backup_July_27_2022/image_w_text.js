...
function alt_text_button(atb)
{
    if(comp_data[0][1].length > 125)   // \""+String(iwt_btn_id)+"\"
    {
      ...
      //  console.log("iwt_btn_id: " + iwt_btn_id); ////iwt_btn_"+comp_number
            c_div_maker = c_div_maker + "<div style='margin-top:10px;margin-left:"+IWT_Image_Width+"%; margin-right:"+IWT_Image_Width+"%'><button id='"+iwt_btn_id+"' class='btn btn-primary btn-sm' onclick='alt_tag_text(\""+String(comp_data[0][1])+"\",\""+String(iwt_btn_id)+"\")'>Image Description</button></div>"; //onclick='alt_tag_image("+atb+",0,2)'
    } //\""+String(imgAlttext)+"\"

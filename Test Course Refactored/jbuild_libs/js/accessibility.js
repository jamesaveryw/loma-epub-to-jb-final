...
function openModal(e) {
    ...
    switch (true) {
        ...
        case (/(?:pdf_inline_style|keyterm)/.test(targetClass)):
            parentClass = 'c_jb_modal';
            modalContClass = 'c_jb_modal-hdr-ftr';
            break;
    ...
    if (parentClass) {
        ...
        modalCont = parent.querySelector(`.${modalContClass}`);
...
function modalTrap(e) {
    ...
    if (e.which === keyCodes.ESC) {
        ...
        let closeBtn = (document.querySelector('.modal-close-btn') && document.querySelector('.modal-close-btn').offsetParent != null) ? document.querySelector('.modal-close-btn') : document.querySelector('#kt_btn button');
        ...
        for (let func of funcs) {
            func = func.replace(/javascript:\s?/g, "");

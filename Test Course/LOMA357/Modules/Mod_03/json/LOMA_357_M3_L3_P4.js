Lesson_Data_File([
    {
        "Page_Setup": {
            ...
            "Lesson_Title_Text": "",
            "Page_Title": "Metrics for Performance Measurement",
        ...
        "JBuilder_Content": [
            {
                "Heading": [
                    {
                        "sngl_Heading": "Metrics for Performance Measurement"
                    },
                    {
                        "alignment": "center"
                    },
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "Two metrics for measuring a portfolio’s return for a given period are total return and excess return."
                    }
                ]
            },
            {
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Rate of excess return"
                                    },
                                    {
                                        "Data_Info": "="
                                    },
                                    {
                                        "Data_Info": "Portfolio’s rate of total return <wbr>– <wbr>Benchmark rate of total return"
                                    }
                                ],
                                "Row_Data_Color": "",
                                "Row_Data_Height": "",
            ...
            },
            {
                "List_text_paragraph": [
                    ...
                    },
                    {
                        "Top_Paragraphs": [
                            {
                                "Paragraph_text": "For example, if a portfolio’s rate of total return for the past year was 7% and the benchmark’s rate of total return for the same period was 5%, then the portfolio’s rate of excess return was 2%, calculated as 7% – 5%. Thus, for a particular portfolio, if the rate of excess return for a given period is"
                            }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        "list_items": [
                            {
                                "lstText": "Positive, then the portfolio outperformed its benchmark over the period"
                            },
                            {
                                "lstText": "Negative, then the portfolio underperformed its benchmark over the period; you could also say that the benchmark outperformed the portfolio over the period"
                            }
                        ]
                    },
                    {
            ...
            },
            {
                "List_text_paragraph": [
                    ...
                    },
                    {
                        "Top_Paragraphs": [
                            {
                                "Paragraph_text": "Two portfolios share the same performance benchmark. Portfolio 1 has a tracking error of 2.5% and Portfolio 2 has a tracking error of 4%. Suppose the benchmark rate of return is 5% for a given year. Without looking at actual portfolio returns, investment professionals would expect"
                            }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        "list_items": [
                            {
                                "lstText": "Portfolio 1’s rate of return to be between 2.5% (5% – 2.5%) and 7.5% (5% + 2.5%)"
                            },
                            {
                                "lstText": "Portfolio 2’s rate of return to be between 1% (5% – 4%) and 9% (5% + 4%)"
                            }
                        ]
                    },
                    {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "<strong>Analysis</strong>: Portfolio 1 has a smaller tracking error than Portfolio 2. Therefore, in a given year, Portfolio 1’s rate of return is more likely to be closer to the benchmark rate of return than Portfolio 2’s rate of return. Also, the confidence interval for both portfolios is approximately 67%, meaning about 67% of actual returns are likely to fall within the expected ranges in future years."
                    }
                ]
            },
            {
                ...
                "Paragraphs_New": [
                    {
                        ...
                        "border_style": "",
                        "border_radius": "0px",
                        "heading": "<span style=\"font-size:14px;font-weight:bold\">INSIGHT: Visual Representation of a Portfolio’s Value at Risk (VaR)</span>",
                        "heading_font_size": "h5",
                        "heading_alignment": "center",
                        "heading_color": "",
                        "heading_weight": "bold",
                    ...
                    {
                        "Paragraph_txt": "Suppose an investment team is managing a portfolio worth $250 million and wants to measure the portfolio’s downside risk in terms of the maximum investment loss over one month. The team determines that the portfolio has a 95% one-month VaR of $10 million, as indicated below by the area in blue. In other words, the portfolio management team is 95% confident that its one-month loss would not exceed $10 million, which is 4% of the portfolio’s total value, calculated as [($10 / $250) x 100]."
                    }
                ]
            },
            {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "Note that any stated confidence level below 100% allows for the possibility that the actual loss is greater than the estimated maximum loss. Therefore, in this example, there is a 5% chance that the portfolio’s one-month loss would exceed $10 million, as indicated above by the area in red."
                    }
                ]
            },
            {
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Standard Deviation"
                                    },
                                    {
                                        "Data_Info": ". . . the dispersion of a portfolio’s historical returns around its mean return"
                                    },
                                    {
                                        "Data_Info": "Larger values indicate greater historical return volatility, which signifies higher levels of risk"
                                    }
                                ],
                            ...
                            },
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Tracking Error"
                                    },
                                    {
                                        "Data_Info": ". . . the closeness of fit between a portfolio’s returns and the returns of its benchmark"
                                    },
                                    {
                                        "Data_Info": "Larger values indicate a greater degree of return volatility relative to the benchmark and, thus, higher risk exposure"
                                    }
                                ],
                            ...
                            },
                            {
                                "Row_Data": [
                                    ...
                                    {
                                        "Data_Info": ". . . the volatility of a portfolio in relation to the volatility of the market"
                                    },
                                    {
                                        "Data_Info": "Values greater than 1 indicate more return volatility than the market; values less than 1 indicate less volatility than the market; more volatility signifies higher risk"
                                    }
                                ],
                                "Row_Data_Color": "rgba(0, 105, 173, .3)",
                                "Row_Data_Height": "",
                            ...
                            },
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Value at Risk (VaR)"
                                    },
                                    {
                                        "Data_Info": ". . . the maximum amount that a portfolio could lose within a specified time period; metric indicates the level of confidence in the maximum loss estimate"
                                    },
                                    {
                                        "Data_Info": "The loss amount indicates the estimated worst-case scenario within a given period; the probability indicates the likelihood that the actual loss will be equal to or less than the maximum loss estimate"
                                    }
                                ],
                                "Row_Data_Color": "rgba(0, 105, 173, .09)",
                                "Row_Data_Height": "",
                ...
                "Question_Comp": [
                    {
                        ...
                        "image_alt_text": "",
                        "question": "A portfolio’s rate of total return for last year was 8%. The rate of total return for its benchmark was 10%. For the period, the portfolio’s rate of excess return was (<strong>+2% / –2%</strong>). Therefore, the portfolio (<strong>underperformed / outperformed</strong>) its benchmark over the period.",
                        "question_image": "",
                    ...
                    },
                    {
                        "question_answers": [
                            {
                                "q_answer": "+2%; underperformed",
                                "true_false": false,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "+2%; outperformed",
                                "true_false": false,
                                "q_feedback": ""
                            },
                            {
                    ...
                    },
                    {
                        ...
                        "correct_remediation": "The portfolio’s rate of excess return was <strong>–2%</strong>. Because the rate of excess return was negative, the portfolio <strong>underperformed</strong> its benchmark.",
                        "incorrect_feedback": "Sorry. That's incorrect.",
                        "incorrect_remediation": "The portfolio’s rate of excess return was <strong>–2%</strong>. Because the rate of excess return was negative, the portfolio <strong>underperformed</strong> its benchmark.",
                ...
                "Question_Comp": [
                    {
                        ...
                        "image": "",
                        "image_alt_text": "",
                        "question": "Match each risk metric to its correct description. For each description, type the correct number choice in the blank.",
                        "question_image": "",
                        "question_image_placement": "none",
                        "question_image_alt_tag": ""
                    },
                    ...
                    },
                    {
                        "question_answers": [
                            {
                                "q_answer": "Measures the closeness of fit between a portfolio’s returns and the returns of its benchmark",
                                "true_false": false,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "Estimates the maximum amount that a portfolio could lose within a specified time period and assigns a probability to that estimate",
                                "true_false": false,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "Measures the volatility of an asset or portfolio in relation to the volatility of the market",
                                "true_false": false,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "Measures the dispersion of an asset’s (or portfolio’s) historical returns around its mean return",
                                "true_false": false,
                                "q_feedback": ""
                            }
                        ]
                    ...
                    {
                        "correct_feedback": "That's correct!",
                        "correct_remediation": "The first description is of tracking error, the second is of VaR, the third is of beta, and the fourth is of standard deviation.",
                        "incorrect_feedback": "Sorry. That's incorrect.",
                        "incorrect_remediation": "The first description is of tracking error, the second is of VaR, the third is of beta, and the fourth is of standard deviation.",
                        "correct_incorrect_font_size": "jb1",
                        "Additional_feedback": "",
                        "Additional_font_size": "jb1"
                    }
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "One of the most popular risk-adjusted return metrics is the Sharpe ratio. The <span class=\"keyterm\" tabindex=\"0\" role=\"button\">Sharpe ratio</span> measures a portfolio’s returns earned for each unit of risk, when risk is expressed as the standard deviation of portfolio returns. The formula for the Sharpe ratio is"
                    }
                ]
            },
            {
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Sharpe ratio"
                                    },
                                    {
                                        "Data_Info": "="
                                    },
                                    {
                                        "Data_Info": "(Portfolio’s rate of total return <wbr>– <wbr>Risk <wbr>- <wbr>free rate of return)"
                                    }
                                ],
                                "Row_Data_Color": "",
                                "Row_Data_Height": "",
                            ...
                            },
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Standard deviation of portfolio returns"
                                    }
                                ],
                                "Row_Data_Color": "",
                                "Row_Data_Height": "",
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "An investment professional creates the following chart to compare the returns of Portfolio A, Portfolio B, and a benchmark portfolio:"
                    }
                ]
            },
            {
                "JB_Table": [
                    {
                        "Col_Heading": [
                            ...
                            {
                                "Heading": "Portfolio rate of total return"
                            },
                            {
                                "Heading": "Risk-free rate of return"
                            },
                            {
                                "Heading": "Standard deviation of portfolio returns"
                            },
                            {
                                "Heading": "Sharpe ratio"
                            }
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "<strong>Analysis</strong>: Even though Portfolio A and Portfolio B have the same rate of total return, Portfolio A accepted more risk—as indicated by its higher standard deviation—to achieve its returns. Therefore, Portfolio B has a higher Sharpe ratio value, signifying its higher risk-adjusted return. In addition, both portfolios outperformed the benchmark by generating higher rates of total return and higher Sharpe ratio values."
                    }
                ]
            },
            {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "The adjustment for risk is a key factor in the Sharpe ratio. For instance, if two portfolios have the same rate of total return, but one has a higher standard deviation than the other, then the portfolio with the higher standard deviation has the lower Sharpe ratio value. (Look again at the previous example box.) Thus, the portfolio with the lower standard deviation used less risk to generate the same return."
                    }
                ]
            },
            {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "Another way to measure a portfolio management team’s effectiveness in using risk to generate returns is the information ratio. The <span class=\"keyterm\" tabindex=\"0\" role=\"button\">information ratio</span> is the ratio of the excess return for a portfolio divided by the portfolio’s tracking error; the result is usually expressed as a percentage. Note that if the tracking error is expressed as a percentage, the excess return will also be expressed as a percentage—the rate of excess return. The information ratio formula is"
                    }
                ]
            },
            {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "An investment professional creates the following chart to compare the returns of Portfolio A and Portfolio B over the same period:"
                    }
                ]
            },
            {
                "JB_Table": [
                    {
                        "Col_Heading": [
                            ...
                            {
                                "Heading": "Portfolio rate of excess return"
                            },
                            {
                                "Heading": "Portfolio tracking error"
                            },
                            {
                                "Heading": "Information ratio"
                            }
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "<strong>Analysis</strong>: Portfolio A has the higher information ratio value. Therefore, Portfolio A was better than Portfolio B at using risk to generate returns for the given period."
                    }
                ]
            },
            {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "The Sharpe ratio, Sortino ratio, and information ratio have similar formulas. For instance, they all use a return calculation in the ratio’s numerator and a standard deviation calculation in the ratio’s denominator. The key differences in the ratios are listed in the chart below:"
                    }
                ]
            },
            {
                "JB_Table": [
                    {
                        "Col_Heading": [
                            ...
                            {
                                "Heading": "Basis for Return Calculation<br/>(Numerator)"
                            },
                            {
                                "Heading": "Basis for Risk Calculation<br/>(Denominator)"
                            }
                        ],
                        "Row_Heading_Color": "#0069ad",
                        "Row_Heading_Height": "",
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    ...
                                    {
                                        "Data_Info": "Portfolio’s rate of total return in excess of the risk-free rate of return"
                                    },
                                    {
                                        "Data_Info": "Standard deviation of portfolio’s historical returns; includes positive and negative return volatility"
                                    }
                                ],
                                "Row_Data_Color": "rgba(0, 105, 173, .3)",
                                "Row_Data_Height": "",
                            ...
                            },
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Sortino Ratio"
                                    },
                                    {
                                        "Data_Info": "Portfolio’s rate of total return in excess of the risk-free rate of return"
                                    },
                                    {
                                        "Data_Info": "Standard deviation of portfolio’s historical returns; only considers negative return volatility"
                                    }
                                ],
                                "Row_Data_Color": "rgba(0, 105, 173, .09)",
                                "Row_Data_Height": "",
                            ...
                            },
                            {
                                "Row_Data": [
                                    ...
                                    {
                                        "Data_Info": "Portfolio’s rate of total return in excess of its benchmark’s rate of total return"
                                    },
                                    {
                                        "Data_Info": "Tracking error, which is the standard deviation of the difference between the portfolio’s returns and the returns of its benchmark"
                                    }
                                ],
                                "Row_Data_Color": "rgba(0, 105, 173, .3)",
                                "Row_Data_Height": "",
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Portfolio’s expected rate of return"
                                    },
                                    {
                                        "Data_Info": "="
                                    },
                                    {
                                        "Data_Info": "Risk <wbr>- <wbr>free rate of return <wbr>+ <wbr>(Portfolio’s beta × [Rate of market return <wbr>– <wbr>Risk <wbr>- <wbr>free rate of return])"
                                    }
                                ],
                                "Row_Data_Color": "",
                                "Row_Data_Height": "",
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "In the above formula, investment professionals typically use the rate of return of a market index as a proxy for the rate of the market’s return. Using our expected rate of return formula, we can express the Jensen’s alpha formula as"
                    }
                ]
            },
            {
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Jensen’s alpha"
                                    },
                                    {
                                        "Data_Info": "="
                                    },
                                    {
                                        "Data_Info": "Portfolio’s actual rate of return <wbr>– <wbr>Portfolio’s expected rate of return"
                                    }
                                ],
                                "Row_Data_Color": "",
                                "Row_Data_Height": "",
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    ...
                                    {
                                        "Data_Info": "Portfolio’s actual rate of return <wbr>– <wbr>(Risk <wbr>- <wbr>free rate of return <wbr>+ <wbr>[Portfolio’s beta × {Rate of market return <wbr>– <wbr>Risk <wbr>- <wbr>free rate of return}])"
                                    }
                                ],
                                "Row_Data_Color": "",
                                "Row_Data_Height": "",
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "An investment professional is calculating the Jensen’s alpha value for a portfolio’s one-year rate of return. For the same period, the risk-free rate of return was 2%, the rate of the market’s return was 7%, and the portfolio’s beta was 1.3. Therefore, the portfolio’s expected rate of return is:"
                    }
                ]
            },
            {
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    ...
                                    {
                                        "Data_Info": "Risk <wbr>- <wbr>free rate of return <wbr>+ <wbr>(Portfolio’s beta x [Rate of market return <wbr>– <wbr>Risk <wbr>- <wbr>free rate of return])"
                                    }
                                ],
                                "Row_Data_Color": "",
                                "Row_Data_Height": "",
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    ...
                                    {
                                        "Data_Info": "2% <wbr>+ <wbr>(1.3 x [7% <wbr>– <wbr>2%])"
                                    }
                                ],
                                "Row_Data_Color": "",
                                "Row_Data_Height": "",
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "Unlike the Sharpe, Sortino, and information ratios—which use standard deviation as their measure of risk—Jensen’s alpha uses beta as its measure of risk. Therefore, while the Sharpe, Sortino, and information ratios evaluate returns in relation to the portfolio’s combination of systematic and specific risk, Jensen’s alpha evaluates returns in relation to the portfolio’s systematic risk, or market risk. The following chart summarizes the risk-adjusted return metrics covered in this chapter."
                    }
                ]
            },
            {
                "JB_Table": [
                    {
                        "Col_Heading": [
                            {
                                "Heading": "Risk-Adjusted Return Metric"
                            },
                            {
                                "Heading": "Measures . . ."
                            },
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    ...
                                    {
                                        "Data_Info": ". . . portfolio returns in excess of risk-free returns, per unit of risk"
                                    },
                                    {
                                        "Data_Info": "Larger positive values indicate better risk-adjusted returns; a negative value indicates that the portfolio underperformed relative to a risk-free asset"
                                    }
                                ],
                                "Row_Data_Color": "rgba(0, 105, 173, .3)",
                                "Row_Data_Height": "",
                            ...
                            },
                            {
                                "Row_Data": [
                                    ...
                                    {
                                        "Data_Info": ". . . portfolio returns in excess of risk-free returns, per unit of downside risk"
                                    },
                                    {
                                        "Data_Info": "Larger positive values indicate better risk-adjusted returns; a negative value indicates that the portfolio underperformed relative to a risk-free asset"
                                    }
                            ...
                            },
                            {
                                "Row_Data": [
                                    ...
                                    {
                                        "Data_Info": ". . . portfolio returns in excess of benchmark returns, per unit of risk"
                                    },
                                    {
                                        "Data_Info": "Larger positive values indicate better risk-adjusted returns; a negative value indicates that the portfolio underperformed relative to its benchmark"
                                    }
                                ],
                                "Row_Data_Color": "rgba(0, 105, 173, .3)",
                                "Row_Data_Height": "",
                            ...
                            },
                            {
                                "Row_Data": [
                                    ...
                                    {
                                        "Data_Info": ". . . a portfolio’s actual returns in excess of its expected risk-adjusted returns"
                                    },
                                    {
                                        "Data_Info": "Larger positive values indicate greater outperformance relative to risk-adjusted expectations; a negative value indicates that the portfolio underperformed relative to its expected risk-adjusted return"
                                    }
                                ],
                                "Row_Data_Color": "rgba(0, 105, 173, .09)",
                                "Row_Data_Height": "",
                ...
                "Question_Comp": [
                    {
                        ...
                        "image": "Lets Review.jpg",
                        "image_alt_text": "",
                        "question": "Portfolio 1’s Sharpe ratio is 1.13, Portfolio 2’s is 0.98, and Portfolio 3’s is 0.95. They all share the same benchmark, which has a Sharpe ratio of 1.04.",
                        "question_image": "",
                        "question_image_placement": "none",
                        "question_image_alt_tag": ""
                    },
                    ...
                    },
                    {
                        "question_answers": [
                            {
                                "q_answer": "Of the three portfolios, Portfolio 1 has the best risk-adjusted return.",
                                "true_false": false,
                                "q_feedback": "This statement is true. A higher positive Sharpe ratio value corresponds to a better risk-adjusted return. With a Sharpe ratio of 1.13, Portfolio 1 DOES have the best (highest) risk-adjusted return of the three portfolios."
                            },
                            {
                                "q_answer": "Portfolio 2’s risk-adjusted return is better than Portfolio 3’s, but worse than the benchmark’s.",
                                "true_false": false,
                                "q_feedback": "This statement is true. A higher positive Sharpe ratio value corresponds to a better risk-adjusted return. With a Sharpe ratio of 0.98, Portfolio 2’s risk-adjusted return is higher than Portfolio 3’s (0.95) but lower than the benchmark (1.04)."
                            },
                            {
                                "q_answer": "Of the three portfolios, Portfolio 3 has the worst risk-adjusted return.",
                                "true_false": false,
                                "q_feedback": "This statement is true. A higher positive Sharpe ratio value corresponds to a better risk-adjusted return; a lower value corresponds to a worse return. With a Sharpe ratio of 0.95, Portfolio 3 DOES have the worst (lowest) risk-adjusted return of the three portfolios."
                            },
                            {
                                "q_answer": "The benchmark has a better risk-adjusted return than all three portfolios.",
                                "true_false": true,
                                "q_feedback": "This statement is FALSE. The benchmark does NOT have a better risk-adjusted return than all three portfolios. With a Sharpe ratio of 1.13, Portfolio 1 has a better risk-adjusted return than the benchmark (1.04). Remember that a higher positive Sharpe ratio value corresponds to a better risk-adjusted return."
                            }
                        ]
                    },
                    {
                ...
                "Question_Comp": [
                    {
                        ...
                        "image": "",
                        "image_alt_text": "",
                        "question": "Jensen’s alpha uses (<strong>beta / standard deviation</strong>) as its measure of risk. If the Jensen’s alpha value of a portfolio is (<strong>positive / negative</strong>), then the portfolio has underperformed its expected risk-adjusted return.",
                        "question_image": "",
                        "question_image_placement": "none",
                        "question_image_alt_tag": ""
                    },
                    ...
                    },
                    {
                        "question_answers": [
                            {
                                "q_answer": "Beta; positive",
                                "true_false": false,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "Beta; negative",
                                "true_false": true,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "Standard deviation; positive",
                                "true_false": false,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "Standard deviation; negative",
                                "true_false": false,
                                "q_feedback": ""
                            }
                        ]
                    ...
                    {
                        "correct_feedback": "That's correct!",
                        "correct_remediation": "Jensen’s alpha uses <strong>beta</strong> as its measure of risk. If the value is <strong>negative</strong>, then the portfolio has underperformed relative to expectations.",
                        "incorrect_feedback": "Sorry. That's incorrect.",
                        "incorrect_remediation": "Jensen’s alpha uses <strong>beta</strong> as its measure of risk. If the value is <strong>negative</strong>, then the portfolio has underperformed relative to expectations.",
                        "correct_incorrect_font_size": "jb1",
                        "Additional_feedback": "",
                        "Additional_font_size": "jb1"
                    }

Lesson_Data_File([
    {
        "Page_Setup": {
            ...
            "Lesson_Title_Text": "",
            "Page_Title": "Annuity Surrender and Withdrawal Benefits",
        ...
        "JBuilder_Content": [
            {
                "Heading": [
                    {
                        "sngl_Heading": "Annuity Surrender and Withdrawal Benefits"
                    },
                    {
                        "alignment": "center"
                    },
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Present value of future surrender benefits, Year <em>n</em>"
                                    },
                                    {
                                        "Data_Info": "="
                                    },
                                    {
                                        "Data_Info": "(Number of contracts, beginning of Year <em>n</em>) × (Expected surrender rate, Year <em>n</em>) × (Present value of surrender value per unit, Year <em>n</em>)"
                                    }
                                ],
                                "Row_Data_Color": "",
                                "Row_Data_Height": "",
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Withdrawal value, Year <em>n</em>"
                                    },
                                    {
                                        "Data_Info": "="
                                    },
                                    {
                                        "Data_Info": "(Accumulated value) × (Withdrawal rate, Year <em>n</em>)"
                                    }
                                ],
                                "Row_Data_Color": "",
                                "Row_Data_Height": "",
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "As with surrenders, the insurer sums the withdrawal values for each year of the accumulation period to determine the total value of withdrawals."
                    }
                ]
            },
            {
                "Question_Comp": [
                    ...
                    },
                    {
                        "question_answers": [
                            {
                                "q_answer": "highest / shock lapses",
                                "true_false": false,
                                "q_feedback": "Deferred annuity surrender rates are usually the <strong>lowest</strong> during the early years of the accumulation period. Withdrawals in excess of the allowable rate are subject to <strong>surrender charges</strong>."
                            },
                            {
                                "q_answer": "highest / surrender charges",
                                "true_false": false,
                                "q_feedback": "While withdrawals in excess of the allowable rate are subject to surrender charges, deferred annuity surrender rates are usually the <strong>lowest</strong> during the early years of the accumulation period."
                            },
                            {
                                "q_answer": "lowest / shock lapses",
                                "true_false": false,
                                "q_feedback": "While deferred annuity surrender rates are usually the lowest during the early years of the accumulation period, withdrawals in excess of the allowable rate are subject to <strong>surrender charges</strong>."
                            },
                            {
                                "q_answer": "lowest / surrender charges",
                                "true_false": true,
                                "q_feedback": "Surrender rates for deferred annuities tend to spike after the end of the contract’s surrender charge period."
                            }
                        ]
                    },
                    {

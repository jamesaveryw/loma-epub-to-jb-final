...
debug("function ready");
	...
	var ebook = {
		...
		initialize: function () {
			...
			// interactive exercise icons need alt tags
			var interactiveIcons = document.querySelector('img.wdgtIcon');
          	if (interactiveIcons) {
              for (i = 0; i < interactiveIcons.length; i++) {
                  interactiveIcons[i].setAttribute('alt', 'Interactive Exercise');
              }
            }

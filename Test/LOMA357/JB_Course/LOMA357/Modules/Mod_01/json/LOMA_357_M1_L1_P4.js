                ...
                "JB_Table": [
                    {
                        "Col_Heading": [
                            ...
                            {
                                "Heading": "What types of insurance products do the assets in the account support?"
                            },
                            {
                                "Heading": "Guaranteed products, such as whole life insurance and fixed annuities"
                            },
                            {
                                "Heading": "Nonguaranteed products, such as variable life insurance and variable annuities"
                            },
                            {
                                "Heading": "Who bears the investment risk?"
                            },
                            {
                                "Heading": "The insurance company bears all of the investment risk"
                            },
                            {
                                "Heading": "The customer bears most or all of the investment risk"
                            },
                            {
                                "Heading": "Who has a direct interest in the account’s invested assets?"
                            },
                            {
                                "Heading": "The insurance company"
                            },
                            {
                                "Heading": "The customer"
                            },
                            {
                                "Heading": "Who picks how the account invests premium payments?"
                            },
                            {
                                "Heading": "The insurance company"
                            },
                            ...
                            {
                                "Heading": "Does the benefit amount of the insurance product depend on the market value of the account’s assets?"
                            },
                            {
                                "Heading": "No; generally, benefit amounts are based on contractual guarantees"
                            },
                            {
                                "Heading": "Yes; changes in invested assets’ market values can cause benefit amounts to fluctuate"
                            }
                        ],

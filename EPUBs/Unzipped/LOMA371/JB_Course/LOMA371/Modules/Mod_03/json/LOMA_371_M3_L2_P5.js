Lesson_Data_File([
    {
        "Page_Setup": {
            ...
            "Lesson_Title_Text": "",
            "Page_Title": "Adjusting Tabular Mortality Rates",
        ...
        "JBuilder_Content": [
            {
                "Heading_New": [
                    {
                        "sngl_Heading": "Adjusting Tabular Mortality Rates"
                    },
                    {
                        "alignment": "center"
                    },
            ...
            },
            {
                "List_text_paragraph": [
                    {
                        "List_Heading": "<strong>Projection Method</strong>",
                        "heading_alignment": "center",
                        "heading_style": "bold",
                        "heading_underline": "",
                    ...
                    },
                    {
                        "Top_Paragraphs": [
                            {
                                "Paragraph_text": "The <span class=\"keyterm\" tabindex=\"0\" role=\"button\">projection method</span> for adjusting tabular mortality involves multiplying the tabular mortality rates by a chosen percentage. Tables that have been adjusted using the projection method to account for future changes in mortality are called <span class=\"keyterm\" tabindex=\"0\" role=\"button\">mortality tables with projection</span>."
                            },
                            {
                                "Paragraph_text": "The projection method requires the insurer to choose a percentage that matches the insurer’s expectations for future mortality. For example,"
                            }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        "list_items": [
                            {
                                "lstText": "If the insurer expects people in the specified group to die sooner than the tabular rates indicate, the insurer would multiply the tabular rates by a factor larger than 100 percent."
                            },
                            {
                                "lstText": "If the insurer expects people in the specified group to live longer than the tabular mortality rates indicate, the insurer would multiply the tabular rates by a factor smaller than 100 percent."
                            }
                        ]
                    },
                    {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "When designing a new annuity product, Comet Life Insurance decides to use the projection method to reflect longevity trends that are likely to affect the specified group of potential annuitants. Comet multiplies the tabular rates by 80%, which indicates that Comet expects the group to live longer than expected."
                    }
                ]
            },
            {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "Figure 8.1 compares a portion of a mortality curve based on industry mortality tables with a portion of a mortality curve that is also based on the same tables, but that has also been modified with projection. The curve with projection has been multiplied by a factor of 30 percent, indicating that the insurer is expecting people in the group to live longer. Note that, near age 100, when the unmodified mortality curve has a steep upward slope, the curve with projection has a more gradual slope. Most of the difference at the higher ages reflects a distortion of the curve caused by the projection."
                    }
                ]
            },
            {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "When adjusting a mortality table for a new life insurance product, Comet Life Insurance decides it should use a reduced mortality rate relative to tabular rates for age 35. Comet settles on a two-year age setback for age 35, which uses an age two years younger than the attained age. Comet therefore applies the tabular mortality rate for the group at age 33 to the group at age 35."
                    }
                ]
            },
            {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "Figure 8.2 summarizes various types of mortality tables."
                    }
                ]
            },
            {
            ...
            },
            {
                "Question_Comp": [
                    ...
                    },
                    {
                        "question_answers": [
                            {
                                "q_answer": "projection method",
                                "true_false": true,
                                "q_feedback": "The projection method multiplies mortality rates by a factor smaller than 100 percent if mortality rates are expected to decline, or by a factor larger than 100 percent if mortality rates are expected to increase."
                            },
                            {
                                "q_answer": "setback method",
                                "true_false": false,
                                "q_feedback": "The setback method adjusts a mortality table by applying tabular mortality rates for people of a younger age. The projection method multiplies mortality rates by a percentage to reflect potential decreases or increases in mortality."
                            }
                        ]
                    },
                    {

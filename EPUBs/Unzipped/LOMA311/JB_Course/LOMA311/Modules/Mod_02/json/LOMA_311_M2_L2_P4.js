Lesson_Data_File([
    {
        "Page_Setup": {
            ...
            "Lesson_Title_Text": "",
            "Page_Title": "Principal’s Duties to the Agent",
        ...
        "JBuilder_Content": [
                ...
                "Paragraphs_New": [
                    {
                        ...
                        "border_style": "",
                        "border_radius": "0px",
                        "heading": "Principal’s Duties to the Agent",
            ...
            },
            {
                "image_w_text": [
                    ...
                    {
                        "image_text": "<strong>Figure 5.2</strong> Principal’s Duties to the Agent",
                        "image_list": [],
            ...
            },
            {
                "List_text_paragraph": [
                    ...
                    },
                    {
                        "Top_Paragraphs": [
                            {
                                "Paragraph_text": "The principal and agent typically agree on how the agent is to be paid for services. If the parties do not agree on compensation in advance, the principal has a duty to pay the agent the reasonable value of the agent’s services. What constitutes a reasonable value for services is a question of fact that depends on the circumstances. Factors that might be considered in determining the reasonable value of an agent’s services include"
                            }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        "list_items": [
                            {
                                "lstText": "The types of services the agent provided"
                            },
                            {
                                "lstText": "Prior dealings between the parties"
                            },
                            {
                                "lstText": "Customs and trade practices of the business"
                            }
                        ]
                    },
                    {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "A principal has no duty to pay an agent who agrees to provide services without compensation."
                    }
                ]
            },
            {
            ...
            },
            {
                "image_w_text": [
                    ...
                    {
                        "image_text": "<strong>Figure 5.3</strong> Duties of the Parties in an Agency Relationship",
                        "image_list": [],
                        "list_position": "bottom",
                        "top_margin": "10px",
                        "Type_of_List": "ol",
                ...
                "Question_Comp": [
                    {
                        ...
                        "image_alt_text": "",
                        "question": "An agent’s duties to the principal include (check all that apply):",
                        "question_image": "",
                    ...
                    },
                    {
                        "question_answers": [
                            {
                                "q_answer": "duty of loyalty and good faith",
                                "true_false": true,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "duty of obedience",
                                "true_false": true,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "duty of competence&nbsp;",
                                "true_false": true,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "indemnification",
                                "true_false": false,
                                "q_feedback": ""
                            }
                        ]
                    },
                    {
                        ...
                        "correct_remediation": "An agent’s duties to the principal include duty of loyalty and good faith,duty of obedience, duty of competence, and duty of an accounting. Indemnification,however, is one of the principal’s duties to an agent, rather than an agent’sduty to a principal.",
                        "incorrect_feedback": "Sorry. That's incorrect.",
                        "incorrect_remediation": "An agent’s duties to the principal include duty of loyalty and good faith,duty of obedience, duty of competence, and duty of an accounting. Indemnification,however, is one of the principal’s duties to an agent, rather than an agent’sduty to a principal.",
                ...
                "Question_Comp": [
                    {
                        ...
                        "image": "",
                        "image_alt_text": "",
                        "question": "True/False: An agent has a duty to use reasonable care, skill, and diligence in carrying out her agency duties. The level of care required of an agent is that of a reasonably prudent person who has the same skills as the agent.",
                        "question_image": "",
                        "question_image_placement": "none",
                        "question_image_alt_tag": ""
                    },
                ...
                "Question_Comp": [
                    {
                        ...
                        "image": "",
                        "image_alt_text": "",
                        "question": "True/False: A principal generally has a duty to indemnify an agent for any losses the agent incurs while performing his duties, regardless of the circumstances.",
                        "question_image": "",
                        "question_image_placement": "none",
                        "question_image_alt_tag": ""
                    },
                    ...
                    {
                        "correct_feedback": "That's correct!",
                        "correct_remediation": "This statement is false. A principal generally has a duty to indemnifyan agent for any losses the agent incurs while performing his duties aslong as the loss was not the result of the agent’s negligence or misconduct.",
                        "incorrect_feedback": "Sorry. That's incorrect.",
                        "incorrect_remediation": "This statement is false. A principal generally has a duty to indemnifyan agent for any losses the agent incurs while performing his duties aslong as the loss was not the result of the agent’s negligence or misconduct.",
                        "correct_incorrect_font_size": "jb1",
                        "Additional_feedback": "",
                        "Additional_font_size": "jb1"
                    }

Lesson_Data_File([
    {
        "Page_Setup": {
            ...
            "Lesson_Title_Text": "",
            "Page_Title": "Investment Strategies Related to ALM",
        ...
        "JBuilder_Content": [
            {
                "Heading_New": [
                    {
                        "sngl_Heading": "Investment Strategies Related to ALM"
                    },
                    {
                        "alignment": "center"
                    },
                ...
                "Paragraphs_New": [
                    {
                        ...
                        "border_style": "",
                        "border_radius": "0px",
                        "heading": "Portfolio Immunization",
                        "heading_font_size": "h3",
                        "heading_alignment": "center",
                        "heading_color": "#015d52",
                        "heading_weight": "bold",
                    ...
                    {
                        "Paragraph_txt": "Because life insurer investment portfolios contain debt securities, these portfolios are exposed to interest-rate risk. Investment professionals can protect portfolios from interest-rate risk through a complex investment strategy called <em>portfolio immunization</em>. In general, a <span class=\"keyterm\" tabindex=\"0\" role=\"button\">portfolio immunization</span> strategy consists of any measures taken to protect a portfolio against risk due to interest-rate changes. Effective immunization positions a portfolio so that the portfolio’s value is insensitive—or “immune”—to small changes in interest-rate risk."
                    }
                ]
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "Insurers typically achieve portfolio immunization through the technique of <span class=\"keyterm\" tabindex=\"0\" role=\"button\">duration matching</span>, which involves matching the duration statistics for fixed-income assets—such as bonds—with the duration statistics for the insurance company liabilities that the assets support."
                    }
                ]
            },
            {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "Another ALM-related investment strategy for insurers involves the linking of asset and liability cash flows. A <span class=\"keyterm\" tabindex=\"0\" role=\"button\">portfolio dedication</span> strategy consists of deliberately structuring a portfolio of assets so that the anticipated future cash flows from those assets match the future cash needs that the portfolio was assembled to fulfill."
                    }
                ]
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "Typically, insurers achieve portfolio dedication through the technique of <span class=\"keyterm\" tabindex=\"0\" role=\"button\">cash-flow matching</span>, which involves identifying the patterns of cash outflows for insurance products and matching those cash outflows with a selection of assets that will produce a similar pattern of cash inflows. In other words, portfolio assets are selected for their ability to generate cash inflows that offset the estimated cash outflows related to an insurer’s liabilities."
                    }
                ]
            },
            {
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    ...
                                    {
                                        "Data_Info": "<br/>&#8226; Ensures that a portfolio’s value is insensitive to small changes in interest-rate risk<br/>&#8226; Useful in protecting values of portfolios with long durations"
                                    },
                                    {
                                        "Data_Info": "<br/>&#8226; Ensures that cash inflows from assets offset cash outflows related to liabilities<br/>&#8226; Generally well-suited to life insurance companies"
                                    }
                                ],
                            ...
                            },
                            {
                                "Row_Data": [
                                    ...
                                    {
                                        "Data_Info": "<br/>&#8226; Requires periodic adjustments to keep asset and liability durations matched<br/>&#8226; May be difficult to find assets with durations that are long enough<br/>&#8226; Does not address cash-flow needs"
                                    },
                                    {
                                        "Data_Info": "<br/>&#8226; May be difficult to find enough assets within risk limits that have required characteristics<br/>&#8226; Requires predictable liability cash outflows"
                                    }
                                ],
            ...
            },
            {
                "List_text_paragraph": [
                    {
                        "List_Heading": "<strong>Interest-Rate Anticipation</strong>",
                        "heading_alignment": "center",
                        "heading_style": "bold",
                        "heading_underline": "",
                    ...
                    },
                    {
                        "Top_Paragraphs": [
                            {
                                "Paragraph_text": "An investment professional using an <span class=\"keyterm\" tabindex=\"0\" role=\"button\">interest-rate anticipation strategy</span> trades fixed-income securities in anticipation of estimated future changes in market interest rates. This strategy has the objectives of (1) preserving capital when interest rates are increasing and (2) achieving capital appreciation when interest rates are decreasing."
                            },
                            {
                                "Paragraph_text": "Investment professionals can attain interest-rate anticipation objectives by altering a portfolio’s duration. Recall that portfolios with longer durations tend to gain the most in market value when interest rates decrease and lose the most in market value when interest rates increase. Therefore, when investment professionals expect interest rates to"
                            }
                        ]
                    },
                    {
                    ...
                    },
                    {
                        "list_items": [
                            {
                                "lstText": "Decrease, they should take steps to increase a portfolio’s duration, thus positioning the portfolio for larger gains in market value as rates decrease"
                            },
                            {
                                "lstText": "Increase, they should take steps to reduce a portfolio’s duration, thus positioning the portfolio for smaller losses in market value as rates increase"
                            }
                        ]
                    },
                    {
                ...
                "Question_Comp": [
                    {
                        ...
                        "image_alt_text": "",
                        "question": "Duration matching is an investment technique that involves selecting assets so that their cash inflows will match the pattern of cash outflows for a particular life insurance product.",
                        "question_image": "",
                    ...
                    },
                    {
                        ...
                        "correct_remediation": "This statement is false. Cash-flow matching involves selecting assetsso that their cash inflows will match the pattern of cash outflows fora particular life insurance product. Duration matching involves matchingthe duration statistics for fixed-income assets—such as bonds—with theduration statistics for the liabilities that those assets support.",
                        "incorrect_feedback": "Sorry. That's incorrect.",
                        "incorrect_remediation": "This statement is false. Cash-flow matching involves selecting assetsso that their cash inflows will match the pattern of cash outflows fora particular life insurance product. Duration matching involves matchingthe duration statistics for fixed-income assets—such as bonds—with theduration statistics for the liabilities that those assets support.",
                ...
                "Question_Comp": [
                    {
                        ...
                        "image": "",
                        "image_alt_text": "",
                        "question": "Portfolios with fixed-income assets are sensitive to a certain type of risk. Investment professionals can use a complex investment strategy called (<strong>portfolio immunization / portfolio dedication</strong>) to protect a portfolio against this type of risk, called (<strong>strategic risk / interest-rate risk</strong>).",
                        "question_image": "",
                        "question_image_placement": "none",
                        "question_image_alt_tag": ""
                    },
                    ...
                    },
                    {
                        "question_answers": [
                            {
                                "q_answer": "Portfolio immunization; strategic risk",
                                "true_false": false,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "Portfolio immunization; interest-rate risk",
                                "true_false": true,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "Portfolio dedication; strategic risk",
                                "true_false": false,
                                "q_feedback": ""
                            },
                            {
                                "q_answer": "Portfolio dedication; interest-rate risk",
                                "true_false": false,
                                "q_feedback": ""
                            }
                        ]
                    ...
                    {
                        "correct_feedback": "That's correct!",
                        "correct_remediation": "<strong>Portfolio immunization</strong> is a strategy to protect a portfoliowith fixed-income assets against <strong>interest-rate risk</strong>.",
                        "incorrect_feedback": "Sorry. That's incorrect.",
                        "incorrect_remediation": "<strong>Portfolio immunization</strong> is a strategy to protect a portfoliowith fixed-income assets against <strong>interest-rate risk</strong>.",
                        "correct_incorrect_font_size": "jb1",
                        "Additional_feedback": "",
                        "Additional_font_size": "jb1"
                    }

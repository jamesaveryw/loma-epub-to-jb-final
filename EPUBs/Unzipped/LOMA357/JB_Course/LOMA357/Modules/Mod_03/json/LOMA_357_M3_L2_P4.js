        ...
        "JBuilder_Content": [
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Yield spread"
                                    },
                                    {
                                        "Data_Info": "="
                                    },
                                    {
                                        "Data_Info": "Yield of the higher <wbr>- <wbr>yielding bond <wbr>– <wbr>Yield of the lower <wbr>- <wbr>yielding bond "
                                    }
                                ],
                                "Row_Data_Color": "",
                                "Row_Data_Height": "",
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "<strong>Analysis</strong>: As compared to the Treasury bond, Bond 2 has the higher quoted yield. Bond 2’s yield is 40 basis points higher than Bond 1’s yield (200 – 160). Therefore, Bond 2 is riskier than Bond 1, although both bonds are riskier than the Treasury bond."
                    }
                ]
            },
            {
            ...
            },
            {
                "Paragraphs_New": [
                    ...
                    {
                        "Paragraph_txt": "A stock trader looking to execute a trade order at the best price pays attention to the stock’s bid-ask spread. The trader can also choose how the trade is executed by selecting a particular order type."
                    }
                ]
            },
            {
                        ...
                        "Row_Information": [
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Can the trader specify a certain number of shares?"
                                    },
                                    {
                                        "Data_Info": "Yes"
                                    },
                            ...
                            },
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Can the trader control the execution price?"
                                    },
                                    {
                                        "Data_Info": "No"
                                    },
                            ...
                            },
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Does the trade usually execute immediately?"
                                    },
                                    {
                                        "Data_Info": "Yes"
                                    },
                            ...
                            },
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "What size bid-ask spread is the order well-suited for<strong>?</strong> "
                                    },
                                    {
                                        "Data_Info": "Typically narrow spreads only"
                                    },
                                    {
                                        "Data_Info": "Any size, but particularly useful for wide spreads"
                                    }
                                ],
                                "Row_Data_Color": "rgba(0, 105, 173, .09)",
                                "Row_Data_Height": "",
                            ...
                            },
                            {
                                "Row_Data": [
                                    {
                                        "Data_Info": "Generally used by institutional investors?"
                                    },
                                    {
                                        "Data_Info": "No"
                                    },
            ...
            },
            {
                "Question_Comp": [
                    ...
                    },
                    {
                        ...
                        "correct_remediation": "All of these are correct answers. The yield spread is a useful comparison metric for bond traders.",
                        "incorrect_feedback": "Sorry. That's incorrect.",
                        "incorrect_remediation": "All of these are correct answers. The yield spread is a useful comparison metric for bond traders.",
            ...
            },
            {
                "Question_Comp": [
                    ...
                    {
                        "correct_feedback": "That's correct!",
                        "correct_remediation": "Wider bid-ask spreads have a negative effect on transaction costs.",
                        "incorrect_feedback": "Sorry. That's incorrect.",
                        "incorrect_remediation": "Wider bid-ask spreads have a negative effect on transaction costs.",
                        "correct_incorrect_font_size": "jb1",
                        "Additional_feedback": "",
                        "Additional_font_size": "jb1"
                    }
